      ...
      <div className="container flex-auto max-w-md max-h-min px-10 py-5 rounded-xl shadow-md bg-theme-white">
        ...
        <form>
          <div className="container flex items-start flex-col">
            ...
            <input type="email" className="form-input w-full px-3 py-2 mt-2 rounded-xl border-0" placeholder="Enter your email"></input>
            <br />
            <p className="text-sm">Password</p>
            <input type="password" className="form-input w-full px-3 py-2 mt-2 rounded-xl border-0" placeholder="Enter your password"></input>
            <br />
        ...
        <div className="flex flex-col justify-center">
          ...
          <p className="font-bold text-sm text-theme-blue">Register</p>
        </div>
      </div>
    </div>
  )
