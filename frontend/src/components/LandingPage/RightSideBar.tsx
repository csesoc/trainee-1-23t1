    ...
    <div className="bg-theme-yellow w-full p-5">
      <Link to={'my_profile'}>
        <div className="flex flex-row m-1">
          <img src={defaultPfp} alt="defaultPfp" width="100" className="rounded-full bg-theme-blue" />
...
const RightSidebar = () => {
  return (
    <div className={`absolute top-0 right-0 bottom-[82px] flex flex-col w-1/3 m-10`}>
      <ProfileInfo />
      <PendingPartners />
    </div>
  );
